...
There is also another vector space whose basis is defined by evaluating the gradient of scalar function at $P$.
...
To revover Newtonian graivty, impose following boundary conditions to field equation:
\begin{enumerate}
...
\begin{enumerate}
  ...
  \item Recover to Newtonian gravity at Newtonian limit.
  \item Asymptotic flatness.
\end{enumerate}

The surface at \(r = 2GM\) is know as \textbf{Schwarzschild horizon}, this radius is know as Schwarzschild radius. 
This leat to the idea of black hole, which nothing can escape from horizon (at least in classical limit, we will see later discussion of Hawking radiation). \\
We can calculate the timelike geodesic form the metric, which implying planetary motion in general relativity, lead to famous result of precession of perihelion of Mercury. 
