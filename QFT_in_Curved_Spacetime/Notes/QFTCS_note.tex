...
\begin{example}[Hadamard elementary function]\label{thef}
...
\begin{equation}
  x^{\mu}=\left(\alpha\sinh(\frac{\tau}{\alpha}),\alpha \cosh(\frac{\tau}{\alpha}),0,0 \right)
\end{equation}
...
\begin{align}
  \mathcal{G}^{(1)}(\Delta\tau) & =\mathcal{G}^{+}(\Delta\tau)+\mathcal{G}^{+}(-\Delta\tau)                                                                                                                    \\
                                & =-\frac{1}{2\pi^2}\sum_{k=-\infty}^{\infty}\left[\Delta\tau+ik(2\pi\alpha)\right]^{-2}-\frac{1}{2\pi^2}\sum_{k=-\infty}^{\infty}\left[-\Delta\tau-ik(2\pi\alpha)\right]^{-2} \\
