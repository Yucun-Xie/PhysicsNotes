...
To achieve this, first define the inner production of mode functions:
...
By explicit calculate the inner product \(\left(f_{\mathbf{k}},f_{\mathbf{k}'}\right)\),
...
\begin{definition}[Mode expansion]
...
\begin{definition}[Vacuum]
  \[\forall \mathbf{k},\;\bigl[ \hat{a}_{\mathbf{k}}\ket{0}=0\bigr].\]
\end{definition}
