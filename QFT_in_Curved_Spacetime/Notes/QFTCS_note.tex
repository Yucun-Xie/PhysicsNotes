...
If we want to calculate the transition probability to all possible states, we could squaring the expression \ref{TA1} and 
summing over the complete set of \(\ket{\psi}\), with resulting 
\begin{align}
  \sum_{\psi}|\braket{\psi,E_1}{0,E_0}|^2&=
\end{align}
