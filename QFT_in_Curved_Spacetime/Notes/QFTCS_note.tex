...
\begin{equation}
  \mathcal{G}^+(x^{\mu},x'^{\mu})=-\frac{1}{4\pi^2}\left(\frac{\Delta\tau}{\sqrt{1-|\mathbf{v}|^2}} -i\epsilon\right).
\end{equation}
...
\begin{align}
  ...
  \left[-\frac{1}{4\pi^2}\left(\frac{\Delta\tau}{\sqrt{1-|\mathbf{v}|^2}} -i\epsilon\right)\right]                            \\
...
\begin{equation}
  y=z=0, \quad x=\sqrt{t+\alpha} \quad \alpha=\text{constant}
\end{equation}
This represents a detector that accelerates uniformly with acceleration \(\alpha^{-1}\) in the detector's frame, i.e. Rinder frame.

The detector's proper time \(\tau\) is related to \(t\) by
\begin{equation}
  t=\alpha \sinh(\frac{\tau}{\alpha})
\end{equation}
